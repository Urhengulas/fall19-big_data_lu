...
import BPTK_Py
from src.visualization.modules import CanvasGrid
from src.visualization.portrayals import portray
import random
from src.visualization.CarChartVisualization import CarChartModule
from src.visualization.CarCostChartVisualization import CarCostChartModule
from src.visualization.ControllerChartVisualization import ControllerChartModule
...
def setup_model(bptk):
    ...
    return model, [canvas_element,charge_chart,revenue_cost_chart,controller_chart]
